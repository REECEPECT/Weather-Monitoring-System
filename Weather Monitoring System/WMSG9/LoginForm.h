...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button2->Font = (gcnew System::Drawing::Font(L"Segoe UI", 11.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button2->ForeColor = System::Drawing::Color::Blue;
			this->button2->Location = System::Drawing::Point(102, 245);
			...
			this->button1->Location = System::Drawing::Point(20, 245);
			...
			this->checkBox2->Location = System::Drawing::Point(21, 217);
			...
			this->checkBox1->Location = System::Drawing::Point(21, 217);
			...
			// flowLayoutPanel1
			// 
			this->flowLayoutPanel1->Location = System::Drawing::Point(21, 118);
			this->flowLayoutPanel1->Name = L"flowLayoutPanel1";
			this->flowLayoutPanel1->Size = System::Drawing::Size(210, 1);
			this->flowLayoutPanel1->TabIndex = 20;
			// 
			// flowLayoutPanel2
			// 
			this->flowLayoutPanel2->Location = System::Drawing::Point(21, 170);
			this->flowLayoutPanel2->Name = L"flowLayoutPanel2";
			this->flowLayoutPanel2->Size = System::Drawing::Size(210, 1);
			...
			this->textBox1->Font = (gcnew System::Drawing::Font(L"Segoe UI", 8.25F));
			this->textBox1->ForeColor = System::Drawing::Color::White;
			this->textBox1->Location = System::Drawing::Point(21, 97);
			...
			this->textBox2->Font = (gcnew System::Drawing::Font(L"Segoe UI", 8.25F));
			this->textBox2->ForeColor = System::Drawing::Color::White;
			this->textBox2->Location = System::Drawing::Point(21, 149);
			...
			this->label10->Location = System::Drawing::Point(237, 156);
			...
			this->label8->Font = (gcnew System::Drawing::Font(L"Segoe UI", 9, System::Drawing::FontStyle::Underline, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label8->ForeColor = System::Drawing::Color::MediumBlue;
			this->label8->Location = System::Drawing::Point(119, 190);
			this->label8->Name = L"label8";
			this->label8->Size = System::Drawing::Size(88, 15);
			this->label8->TabIndex = 13;
			this->label8->Text = L"Reset Password";
			...
			this->label9->Font = (gcnew System::Drawing::Font(L"Segoe UI", 8.75F));
			this->label9->ForeColor = System::Drawing::Color::MediumBlue;
			this->label9->Location = System::Drawing::Point(109, 217);
			...
			this->label4->Location = System::Drawing::Point(109, 217);
			...
			this->label7->Location = System::Drawing::Point(18, 190);
			this->label7->Name = L"label7";
			this->label7->Size = System::Drawing::Size(100, 15);
			this->label7->TabIndex = 9;
			this->label7->Text = L"Forgot password\?";
			// 
			// label2
			// 
			...
			this->label2->Location = System::Drawing::Point(18, 79);
			...
			this->ClientSize = System::Drawing::Size(504, 302);
...
#pragma endregion
		public:
			AdminHeader^ adminHomePage = gcnew AdminHeader(this);
	private: System::Void LoginForm_Load(System::Object^ sender, System::EventArgs^ e) {
	}
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {		
		UserForm^ userHomePage = gcnew UserForm(this);
		//String^ hint;
		String^ constring = L"datasource = localhost; port = 3306;username = root; password = Nonkosi14";
		MySqlConnection^ conDataBase = gcnew MySqlConnection(constring);
		MySqlCommand^ cmdDatabase = gcnew MySqlCommand("select * from wms_db.wmsdb where username = '" + this->textBox1->Text + "'  and password = '" + this->textBox2->Text + "';", conDataBase);
...
private: System::Void label8_Click(System::Object^ sender, System::EventArgs^ e) {
	ResetPWForm^ resetPage = gcnew ResetPWForm();
	this->Hide();
	resetPage->Show();
}
};
