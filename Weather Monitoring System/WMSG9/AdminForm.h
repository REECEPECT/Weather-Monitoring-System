...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->panel8->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &AdminForm::panel8_Paint);
			// 
			// pictureBox6
			// 
			...
			this->dataGridView1->CellClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &AdminForm::dataGridView1_CellClick);
			// 
			// AdminForm
			// 
